...
//EOF;
        ...
        if (($sign === $dataSign)
            ...
            $goodsName = $orderGoodsModel->getGoodsNameByOrderId($order['order_id']);
            $params = [
                'touser' => Cache::get($token)['openid'],
                'template_id' => 'xmZyLfcQPqPiGmminuHwz7qu22zngCCEB-yvOI8fvFc',
