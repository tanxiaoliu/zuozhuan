                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">编辑商户</div>
                            </div>
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-form-file">
                                        ...
                                        <div class="uploader-list am-cf">
                                            <?php if ($model['zhao']): ?>
                                                <div class="file-item">
                                                    <img src="<?= $model['zhao']['file_path'] ?>">
                                                    <input type="hidden" name="category[zheng_id]"
                                                           value="<?= $model['zhao_id'] ?>">
                                                    <i class="iconfont icon-shanchu file-item-delete"></i>
                                                </div>
                                            <?php endif; ?>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-form-file">
                                        <button type="button"
                                                class="upload-zheng am-btn am-btn-secondary am-radius">
                                            <i class="am-icon-cloud-upload"></i> 选择图片
                                        </button>
                                        <div class="uploader-list am-cf">
                                            <?php if ($model['zheng']): ?>
                                                <div class="file-item">
                                                    <img src="<?= $model['zheng']['file_path'] ?>">
                                                    <input type="hidden" name="category[zheng_id]"
                                                           value="<?= $model['zheng_id'] ?>">
                                                    <i class="iconfont icon-shanchu file-item-delete"></i>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="category[good_type]"
                                           value="<?= $model['good_type'] ?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="category[preferential]"
                                           value="<?= $model['preferential'] ?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="category[start_price]"
                                           value="<?= $model['start_price'] ?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="category[send_price]"
                                           value="<?= $model['send_price'] ?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
