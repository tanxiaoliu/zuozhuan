                    ...
                    <div class="widget-title am-cf">
                        <ul class="left-sidebar-second">
                            <li class="sidebar-second-item">
                                <a href="index.php?s=/store/order/delivery_list/category_id/<?= $category_id ?>" class="<?php if ($title == '待发货' ) echo 'active' ?>">待发货</a>
                                <a href="index.php?s=/store/order/receipt_list/category_id/<?= $category_id ?>" class="<?php if ($title == '待收货' ) echo 'active' ?>">待收货</a>
                                <a href="index.php?s=/store/order/pay_list/category_id/<?= $category_id ?>" class="<?php if ($title == '待付款' ) echo 'active' ?>">待付款</a>
                                <a href="index.php?s=/store/order/complete_list/category_id/<?= $category_id ?>" class="<?php if ($title == '已完成' ) echo 'active' ?>">已完成</a>
                                <a href="index.php?s=/store/order/cancel_list/category_id/<?= $category_id ?>" class="<?php if ($title == '已取消' ) echo 'active' ?>">已取消</a>
                                <a href="index.php?s=/store/order/all_list/category_id/<?= $category_id ?>" class="<?php if ($title == '全部订单' ) echo 'active' ?>">全部订单</a>
                            </li>
                        </ul>
                    </div>
                </div>
