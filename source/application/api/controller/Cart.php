...
class Cart extends Controller
{
    ...
    {
        if (!$this->model->add($goods_id, $goods_num, $goods_sku_id, $category_id)) {
    ...
    {
        $this->model->sub($goods_id, $goods_sku_id, $category_id);
    ...
    {
        $this->model->delete($goods_id, $goods_sku_id, $category_id);
        return $this->renderSuccess();
    }
